...
class BurgerBuilder extends Component{
    ...
    addedIngredient = (type) => {
        ...
        this.setState({totalPrice:newPrice,ingredient:updatedIngredient,underFlow:''});
    ...
    lessIngredient = (type) => {
        ...
        if(updatedCount<0)
        {   const updatedUnderflow = 'This Ingredient Allready Empty Please Try Another ingredient'
            this.setState({totalPrice:newPrice,ingredient:updatedIngredient,underFlow:updatedUnderflow});
        }
        else{
            updatedIngredient[type]=updatedCount;
